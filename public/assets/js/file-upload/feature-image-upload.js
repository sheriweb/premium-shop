...
(function ($) {
    $.fn.imageUploaderFeature = function (options) {
        let defaults = {
            preloaded: [],
            imagesInputName: 'feature_image',
        ...
        let createImg = function (src, id) {
            ...
            $button.on("click", function (e) {
                ...
                document.getElementById('feature-product-uploads').files = dataTransfer.files
                $container.remove();
