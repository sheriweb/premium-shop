                            ...
                            @if(isset($product->attributes))
                                <div class="product_image_main">
                                    <div class="product_image">
                                        <img class="pdp-main-img"
                                             src="{{asset('admin-images/attribute-images/'.$product->attributes->first()->image)}}">
                                    </div>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="product_detail_main">
                            <div class="product_name">
                                ...
                                <div class="product_price">
                                    <span class="price original_price">{{$product->attributes->first()->price}}</span>
                                        ...
                                        @foreach($product->attributes as $attribute)
                                            <lable class="item">
                                                <input type="radio" name="color[]"
                                                       value="{{@$attribute->color->color_name}}">
                            ...
                            <hr class="line_break">
                            <button type="submit" name="add" id="AddToCart-7088971481148" style="width: 100%"
                                    class="btn-primary add-to-cart " data-acsb-clickable="true"
                    ...
                    <div class="slider_items_more">
                        <a href="#">
                            ...
                            <div class="product_item_detail mt-1" style="margin-left: 17px;">
                                ...
                                <p class="product_item_detail_text" style=" font-size: 16px; margin-bottom: 0px;">This
                                    leather satchel features 1 zipper pocket</p>
                                <div class="product_price">
