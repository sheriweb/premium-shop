...
@section('content')
    ...
    <section id="shopify-section-template--15113360179260__gradient-banner" class="shopify-section page-width">
        <link
            href="//cdn.shopify.com/s/files/1/0291/4536/6588/t/236/assets/full-page-gradient-banner.css?v=177904305298563803051678725756"
            rel="stylesheet" type="text/css" media="all">
        <div class="fullPageGradientBanner" data-acsb-overflower="true">

            <img
                src="https://cdn.shopify.com/s/files/1/0291/4536/6588/files/store-directory-cover.jpg?v=1643303683&amp;width=1920"
                alt="Store directory cover"
                srcset="//cdn.shopify.com/s/files/1/0291/4536/6588/files/store-directory-cover.jpg?v=1643303683&amp;width=352 352w, //cdn.shopify.com/s/files/1/0291/4536/6588/files/store-directory-cover.jpg?v=1643303683&amp;width=832 832w, //cdn.shopify.com/s/files/1/0291/4536/6588/files/store-directory-cover.jpg?v=1643303683&amp;width=1200 1200w, //cdn.shopify.com/s/files/1/0291/4536/6588/files/store-directory-cover.jpg?v=1643303683&amp;width=1920 1920w"
                width="2048" height="853" data-acsb-alt-candidate="Store directory cover">
                ...
                @foreach($stores as $store)
                    <div class="col-lg-3 mb-2">
                        <div class="brandListGrid__itemTile__productContent" style="position:relative;">
                            <a href="{{route('home.brand-products',['id'=> $store->id])}}" class="logo-bar__link">
                                <img
                                    src="{{asset('admin-images/store/main-images/'.$store->store_image)}}"
                                    style="width: 50%;"
                                ...
                                <img src="{{asset('admin-images/store/thumbnail-images/'.$store->store_thumbnail)}}"
                                    style="width: 50%;"
                                    class="brandListGrid__itemTile__productContent__logoImage lazyautosizes lazyloaded">
                            </a>
                        </div>
                    </div>
                @endforeach
