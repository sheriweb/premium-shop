...
Route::get('/brands/product', [\App\Http\Controllers\theme\HomeController::class, 'brandProducts'])->name('home.brand-products');
Route::get('/brands/product/description', [\App\Http\Controllers\theme\HomeController::class, 'brandProductsDescription'])->name('home.brand-products-description');
